...
namespace BLiveSitePlugin
{
    ...
    static class API
    {
        ...
        {
            //var url=$"https://www.blive.tv/viewapp/api/v3/blacklist/list?movie_id={movieId}&user_type=2&Uuid={context.Uuid}&Token={context.Token}&Random={context.Random}";
            //var res = await dataSource.GetAsync(url);
            ...
            //return list;
            var list = new List<string>();
            var url = "https://apiv5.blive.tv/api/v5/users/me/blacklists";
        ...
        public static async Task PostCommentAsync(IDataSource server, string liveId, string comment, DateTime postTime, Context context)
        {
            ...
            var url = $"https://apiv5.blive.tv/api/v5/movies/{liveId}/chats";
